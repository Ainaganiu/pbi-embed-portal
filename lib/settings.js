...
async function createReport(data) {
  await pool.query(
    `INSERT INTO reports (id, name, workspace_id, report_id, dataset_id, schema_description, problem_statement, sort_order)
  ...
  await pool.query(
    `UPDATE reports
     SET name = $2, workspace_id = $3, report_id = $4, dataset_id = $5,
         schema_description = $6, problem_statement = $7, sort_order = $8
     WHERE id = $1`,
    [
      id,
      data.name,
